...
```javascript
import flattenShape from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-flatten-shape@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-flatten-shape@v0.1.1-esm/index.mjs';
```
